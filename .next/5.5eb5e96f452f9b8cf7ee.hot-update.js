...
var Contact = function Contact(_ref) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_material_ui_Card__["Card"], {
    ...
    subtitle: phoneNumbers.map(function (p) {
      return "".concat(p.number, " - ").concat(p.label);
    }).join(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 31
      }
...
//# sourceMappingURL=5.5eb5e96f452f9b8cf7ee.hot-update.js.map